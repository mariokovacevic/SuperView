...
#ifndef SUPERVIEWCARDSCAN_SWIFT_H
#define SUPERVIEWCARDSCAN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SuperViewCardScan",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17SuperViewCardScan10CornerView")
...
SWIFT_CLASS("_TtC17SuperViewCardScan10CreditCard")
...
SWIFT_PROTOCOL("_TtP17SuperViewCardScan12ScanDelegate_")
...
SWIFT_CLASS("_TtC17SuperViewCardScan18ScanViewController")
...
@interface SuperView (SWIFT_EXTENSION(SuperViewCardScan))
+ (void)configureCardScan SWIFT_AVAILABILITY(ios,introduced=15.6);
@end



@interface SuperWebView (SWIFT_EXTENSION(SuperViewCardScan)) <ScanDelegate>
- (void)userDidSkip:(ScanViewController * _Nonnull)scanViewController;
- (void)userDidCancel:(ScanViewController * _Nonnull)scanViewController;
- (void)userDidScanCard:(ScanViewController * _Nonnull)scanViewController creditCard:(CreditCard * _Nonnull)creditCard;
@end
